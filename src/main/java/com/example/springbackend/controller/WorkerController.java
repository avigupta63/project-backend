...
// ✅ Allow CORS only for your frontend S3 website
@CrossOrigin(origins = "http://767828727604.s3-website.us-east-2.amazonaws.com")
@RestController
...
public class WorkerController {
    ...
    public ResponseEntity<Worker> save(@RequestBody Worker worker) {
        ...
        return new ResponseEntity<>(workerSave, HttpStatus.OK);
    }
    ...
    public ResponseEntity<String> delete(@PathVariable("id") Long id) {
        ...
        return new ResponseEntity<>("Worker is deleted successfully.", HttpStatus.OK);
    }
}
